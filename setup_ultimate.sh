...
PROFILES["Browser_Agent_Web_Automation"]="Browser-Agentenprofil für Playwright, Browser Use, Crawling, Screenshots, Web-Tests und sichere Web-Analyse."
PROFILES["Local_Codex_IDE_Agent"]="Lokaler Coding-Agent mit Repo-Analyse, Patch-Erstellung, Tests, Dev-Containern und Sandbox-Ausführung."
PROFILES["Model_Evaluation_Benchmark"]="Profil für Modellbenchmarks, Prompt-Evaluation, RAG-Vergleich und nachvollziehbare Qualitätsmessung."
PROFILES["Dataset_Curation_Labeling"]="Datenprofil für Sammeln, Bereinigen, Versionieren, Labeling und RAG-/Fine-Tuning-Vorbereitung."
PROFILES["Synthetic_Data_Generator"]="Profil für synthetische Trainingsdaten, Testfälle, Dialogsets und RAG-Fragen aus lokalen Pipelines."
PROFILES["Knowledge_Graph_RAG"]="Graph-RAG-Profil für Entitäten, Beziehungen und lokale Wissensgraphen mit Retrieval-Schicht."
PROFILES["Email_Calendar_Office_Agent"]="Office-Profil für Kalender, Kontakte, Aufgaben, PDFs, DMS und persönliche Wissensarbeit."
PROFILES["Self_Hosted_Cloud_Sync"]="Cloud-/Sync-Profil für Nextcloud, Syncthing, MinIO, Rclone und lokale Backup-Pfade."
PROFILES["Privacy_Anonymization_Redaction"]="Datenschutzprofil für PII-Erkennung, Schwärzung und DSGVO-nahe Vorverarbeitung."
PROFILES["Prompt_Engineering_Lab"]="Prompt-Labor für Vorlagen, Versionierung, Tests, Regressionen und Guardrail-nahe Promptarbeit."
PROFILES["AI_App_Builder"]="Bauprofil für kleine KI-Webapps, interne Tools, Dashboards und lokale API-UIs."
PROFILES["Robotics_IoT_Edge_AI"]="Edge-AI-Profil für ESP32, MQTT, Sensorik, Kamera-Workflows und lokale Embedded-Projekte."
PROFILES["OSINT_Research_Safe"]="Rechercheprofil für legale Quellenanalyse, Archivierung, Monitoring und private Meta-Suche."
...
TOOLS["Browser_Use"]="Lokales Browser-Agent-Toolkit für Navigation, Interaktion, Formulare und agentische Web-Workflows."
TOOLS["Trafilatura"]="Web-Text- und Inhalts-Extraktion für Recherche, RAG und Crawl-Vorbereitung."
TOOLS["ArchiveBox"]="Self-Hosted Web-Archiv für Snapshots, Quellen und sichere Recherche-Ablagen."
TOOLS["Changedetection_IO"]="Self-Hosted Web-Monitoring für Seitenänderungen und Watchlists."
TOOLS["SearXNG"]="Private Meta-Suchmaschine für lokale Recherche und Quellensichtung."
TOOLS["Devcontainer_CLI"]="CLI für reproduzierbare Development-Container und lokale Coding-Sandboxes."
TOOLS["Ruff"]="Schneller Python-Linter und Formatter für Coding-, Daten- und Eval-Repos."
TOOLS["Black"]="Python-Formatter für konsistente Repository-Standards."
TOOLS["Pytest"]="Python-Testframework für lokale Checks, Patches und Regressionstests."
TOOLS["Prettier"]="Formatter für Markdown, JSON, YAML, CSS sowie JavaScript/TypeScript."
TOOLS["ESLint"]="Linter für JavaScript- und TypeScript-Code in UI- und Agentenprojekten."
TOOLS["LM_Evaluation_Harness"]="Benchmark-Framework für lokale und API-basierte Sprachmodellvergleiche."
TOOLS["Ragas"]="RAG-Evaluationsframework für Retrieval-, Grounding- und Antwortqualität."
TOOLS["DeepEval"]="LLM- und Agenten-Eval-Toolkit mit anwendungsnahen Testfällen."
TOOLS["TruLens"]="Evaluations- und Tracing-Toolkit für LLM-, RAG- und Agenten-Workflows."
TOOLS["Haystack"]="Modulare RAG- und Search-Bibliothek für produktionsnaehere Retrieval-Pipelines."
TOOLS["DVC"]="Data Version Control für Datasets, Modelle und reproduzierbare Datenpipelines."
TOOLS["Label_Studio"]="Self-Hosted Annotation und Labeling für Text, Bild, Audio und Dokumente."
TOOLS["Argilla"]="Self-Hosted Data-Curation- und Feedback-Plattform für Annotation und Review."
TOOLS["Datasette"]="Leichte Daten-UI für SQLite-/DuckDB-nahe Exploration und Auswertung."
TOOLS["Radicale"]="Leichter CalDAV-/CardDAV-Server für Kalender- und Kontakt-Synchronisation."
TOOLS["Vikunja"]="Self-Hosted Aufgaben- und Projektmanagement für lokale Agenten- und Office-Workflows."
TOOLS["Presidio"]="PII-Erkennung und Anonymisierung für Datenschutz- und Dokumentenpipelines."
TOOLS["Distilabel"]="Framework für synthetische Daten, Testfälle und lokale Dataset-Generierung."
TOOLS["FastAPI"]="Leichtes API-Framework für lokale KI-Services und interne Tools."
TOOLS["Streamlit"]="Schnelle Python-UI für Dashboards, Datenansichten und App-Prototypen."
TOOLS["Gradio"]="Einfache Demo- und Interaktionsoberfläche für Modelle und Tools."
TOOLS["PlatformIO"]="IoT- und Embedded-Toolchain für ESP32-, Arduino- und Edge-AI-Projekte."
TOOLS["OpenCV_Python"]="Computer-Vision-Bibliothek für Kamera-, Bild- und Edge-AI-Workflows."
TOOLS["Caddy"]="Reverse Proxy für bewusste Freigabe interner Dienste mit sauberer Trennung."
TOOLS["Authelia"]="Auth- und Access-Gateway für geschützte Self-Hosted-Dienste."
TOOLS["Tabby"]="Self-Hosted Coding-Assistenz für lokale Entwickler- und Agentenumgebungen."
...
TOOL_SCRIPT_NAMES["Browser_Use"]="browser_use"
TOOL_SCRIPT_NAMES["Trafilatura"]="trafilatura"
TOOL_SCRIPT_NAMES["ArchiveBox"]="archivebox"
TOOL_SCRIPT_NAMES["Changedetection_IO"]="changedetection_io"
TOOL_SCRIPT_NAMES["SearXNG"]="searxng"
TOOL_SCRIPT_NAMES["Devcontainer_CLI"]="devcontainer_cli"
TOOL_SCRIPT_NAMES["Ruff"]="ruff"
TOOL_SCRIPT_NAMES["Black"]="black"
TOOL_SCRIPT_NAMES["Pytest"]="pytest"
TOOL_SCRIPT_NAMES["Prettier"]="prettier"
TOOL_SCRIPT_NAMES["ESLint"]="eslint"
TOOL_SCRIPT_NAMES["LM_Evaluation_Harness"]="lm_evaluation_harness"
TOOL_SCRIPT_NAMES["Ragas"]="ragas"
TOOL_SCRIPT_NAMES["DeepEval"]="deepeval"
TOOL_SCRIPT_NAMES["TruLens"]="trulens"
TOOL_SCRIPT_NAMES["Haystack"]="haystack"
TOOL_SCRIPT_NAMES["DVC"]="dvc"
TOOL_SCRIPT_NAMES["Label_Studio"]="label_studio"
TOOL_SCRIPT_NAMES["Argilla"]="argilla"
TOOL_SCRIPT_NAMES["Datasette"]="datasette"
TOOL_SCRIPT_NAMES["Radicale"]="radicale"
TOOL_SCRIPT_NAMES["Vikunja"]="vikunja"
TOOL_SCRIPT_NAMES["Presidio"]="presidio"
TOOL_SCRIPT_NAMES["Distilabel"]="distilabel"
TOOL_SCRIPT_NAMES["FastAPI"]="fastapi"
TOOL_SCRIPT_NAMES["Streamlit"]="streamlit"
TOOL_SCRIPT_NAMES["Gradio"]="gradio"
TOOL_SCRIPT_NAMES["PlatformIO"]="platformio"
TOOL_SCRIPT_NAMES["OpenCV_Python"]="opencv_python"
TOOL_SCRIPT_NAMES["Caddy"]="caddy"
TOOL_SCRIPT_NAMES["Authelia"]="authelia"
TOOL_SCRIPT_NAMES["Tabby"]="tabby"
