#!/bin/bash
# ==============================================================================
# 🚀 ULTIMATIVE INTERAKTIVE INSTALLATIONSPLATTFORM V7
# Projekt: VPS-_Kubernate-_Ollama_OpenClaw_installation
# Fokus: pnpm, llama3.2:1b, Gemini-Fallback, Multi-VPS, gcali & RL, Ruflo, Profile, Auto-Update, Ollama Model Manager, viele neue Tools
# ==============================================================================
...
declare -A PROFILES
PROFILES["Programmierer"]="Tools für Entwicklung, Code-Generierung (DeepSeek Coder), Git-Integration, Huginn."
PROFILES["Media_Musik"]="Tools für Audio/Video (FFmpeg), Audio-AI, Alexa-Integration."
PROFILES["KI_Forschung"]="Spezialisierte Bibliotheken für RL, erweiterte LLM-Modelle (Gemini-1.5-Pro)."
PROFILES["Texter_Werbung_Marketing"]="Tools für Content-Generierung, SEO-Analyse, Social Media, Textproduktion."
...
show_profile_management_menu() {
    ...
    dialog --clear --backtitle "OpenClaw & AI Infrastructure - Ultimate Setup V7" \
...
declare -A TOOLS
TOOLS["OpenManus"]="KI-Agenten-Framework für automatisierte Aufgaben."
TOOLS["OpenClaw"]="KI-Agenten-Framework mit Reinforcement Learning (RL) und Skill-Integration."
TOOLS["Clawhub_CLI"]="Kommandozeilen-Tool zur Interaktion mit Clawhub-Diensten."
TOOLS["OpenClaw_RL"]="Reinforcement Learning Erweiterung für OpenClaw."
TOOLS["Clawbake"]="Tool zur Automatisierung von Builds und Deployments."
TOOLS["n8n"]="Workflow-Automatisierungstool, das viele Apps und Dienste verbindet."
TOOLS["Activepieces"]="Open-Source-Alternative zu Zapier für Workflow-Automatisierung."
TOOLS["Flowise"]="Open-Source-UI für LLM-Anwendungen, basierend auf LangchainJS."
TOOLS["LangFlow"]="UI für LangChain, um LLM-Anwendungen visuell zu erstellen."
TOOLS["Pipedream"]="Serverless-Plattform zur Integration von APIs und Diensten (Self-Hosted).
TOOLS["Huginn"]="Open-Source-Agentensystem, das Aktionen im Web automatisiert."
TOOLS["Zenbot_trader"]="Plattform für automatisierten Krypto-Handel."
...
show_tool_management_menu() {
    ...
    for tool_key in "OpenManus" "OpenClaw" "Clawhub_CLI" "OpenClaw_RL" "Clawbake" "n8n" "Activepieces" "Flowise" "LangFlow" "Pipedream" "Huginn" "Zenbot_trader"; do
        STATUS="off"
...
show_main_menu() {
    dialog --clear --backtitle "OpenClaw & AI Infrastructure - Ultimate Setup V7" \
    --title "HAUPTMENÜ" --menu "Wählen Sie Ihr Ziel-System oder eine Aktion:" 25 70 15 \
    "1" "System-Update (OS & pnpm)" \
    "2" "Ollama Modell-Manager" \
    "3" "Hybrid: Letsung MiniPC + Multi-VPS (Empfohlen)" \
    "4" "Standalone: Nur VPS (Cloud-Native)" \
    "5" "Standalone: Nur MiniPC (Lokal)" \
    "6" "Ruflo: Installation & Management" \
    "7" "Tools: Installieren & Deinstallieren" \
    "8" "Profile: Installieren & Deinstallieren" \
    "9" "Dokumentation & API-Key Guide" \
    "10" "System-Check & Port-Analyse" \
    "11" "OpenClaw starten (Dev-Modus)" \
    "12" "Home Assistant starten" \
    "13" "Beenden" 2> /tmp/menu_choice
}
