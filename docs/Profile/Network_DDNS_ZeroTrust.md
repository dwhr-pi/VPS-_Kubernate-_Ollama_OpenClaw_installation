# Network DDNS ZeroTrust

## Status

- Status: `planned` / `documentation-first`
- Ressourcenklasse: `medium`
- Zielgeraete: Oracle VPS / Raspberry Pi / Home Server
- Auto-Installation: nein

## Zweck

Hurricane Electric DDNS, WireGuard/Headscale, Reverse Proxy und geschuetzte Admin-Zugaenge.
...
`wireguard`, `headscale`, `ddclient`, `caddy`, `traefik`, `nginx_proxy_manager`, `authelia`, `authentik`
