# Media Music Video Studio

## Status

- Status: `planned` / `documentation-first`
- Ressourcenklasse: `gpu-heavy`
- Zielgeraete: GPU Workstation / RTX Server
- Auto-Installation: nein

## Zweck

Lokale Audio-, Video- und Bildpipelines fuer Creator-Workflows; schwere Komponenten nur mit Opt-in.
...
`comfyui`, `invokeai`, `automatic1111`, `krita_ai_diffusion`, `blender`, `ffmpeg`, `audacity`
