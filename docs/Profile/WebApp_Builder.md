...
Web-App-Prototypen mit sicheren Defaults.
...
```text
Pruefe das Profil WebApp_Builder fuer mein System. Erstelle einen sicheren Installationsplan mit Ressourcencheck, aber starte keine schweren Installer automatisch.
```
