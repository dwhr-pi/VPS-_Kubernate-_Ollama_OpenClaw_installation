# Prompt_Testing_Evals

## Zweck

Prompt-Regressionen und Eval-Sets.
...
```text
Pruefe das Profil Prompt_Testing_Evals fuer mein System. Erstelle einen sicheren Installationsplan mit Ressourcencheck, aber starte keine schweren Installer automatisch.
```
