...
MCP-Server verwalten und abgesichert bereitstellen.
...
```text
Pruefe das Profil MCP_Server_Hub fuer mein System. Erstelle einen sicheren Installationsplan mit Ressourcencheck, aber starte keine schweren Installer automatisch.
```
