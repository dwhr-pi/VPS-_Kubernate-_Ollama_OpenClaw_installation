# Agent_Evaluation_Lab

## Zweck

Agenten, Prompts und Modellantworten testen.
...
```text
Pruefe das Profil Agent_Evaluation_Lab fuer mein System. Erstelle einen sicheren Installationsplan mit Ressourcencheck, aber starte keine schweren Installer automatisch.
```
