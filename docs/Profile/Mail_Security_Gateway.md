# Mail_Security_Gateway

## Zweck

Mailserver-Sicherheit, DNS, Spam und Authentifizierung.
...
```text
Pruefe das Profil Mail_Security_Gateway fuer mein System. Erstelle einen sicheren Installationsplan mit Ressourcencheck, aber starte keine schweren Installer automatisch.
```
