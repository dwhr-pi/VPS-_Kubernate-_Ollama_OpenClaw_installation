...
- Zielgeraete: MiniPC / Oracle VPS / GPU Workstation
- Auto-Installation: nein

## Zweck

STT/TTS, Telefonie-Workflows, Support-Agenten und lokale Sprachassistenten mit manueller Freigabe.
...
`whisper_cpp`, `faster_whisper`, `piper`, `livekit`, `asterisk`
