...
Home Assistant Agent mit Human Approval.
...
```text
Pruefe das Profil Home_Assistant_Agent fuer mein System. Erstelle einen sicheren Installationsplan mit Ressourcencheck, aber starte keine schweren Installer automatisch.
```
