...
Das Setup soll kein alternatives Python blind in das System schreiben. Stattdessen prueft der Installer zuerst auf kompatible Python-Versionen:
...
Python ist Teil des Ubuntu-Basissystems. Ein automatisches Ersetzen oder Downgrade von `python3` kann Paketverwaltung und Systemtools beschaedigen. Deshalb bleibt FinRAG optional und installiert nur mit explizit kompatiblem Python.
