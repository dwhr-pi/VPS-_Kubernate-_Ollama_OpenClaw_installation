...
Leitfaden fuer voice ethics. Enthalten: Zweck, Setup-Hinweise, Sicherheitsregeln, Speicherorte unter `~/.openclaw_ultimate_user_data/voice_studio/` und keine Rohdaten im Repo.
