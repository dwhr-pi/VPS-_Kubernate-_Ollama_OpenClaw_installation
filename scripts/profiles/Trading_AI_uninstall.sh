...
for tool_script in finrag_uninstall.sh finrobot_uninstall.sh fingpt_uninstall.sh backtest_workflow_uninstall.sh risk_strategy_analyzer_uninstall.sh zenbot_api_uninstall.sh exchange_apis_uninstall.sh web3_apis_uninstall.sh zenbot_trader_uninstall.sh; do
