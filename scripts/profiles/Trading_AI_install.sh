...
for tool_script in zenbot_trader_install.sh web3_apis_install.sh exchange_apis_install.sh zenbot_api_install.sh risk_strategy_analyzer_install.sh backtest_workflow_install.sh fingpt_install.sh finrobot_install.sh finrag_install.sh; do
...
echo -e "${GREEN}Trading_AI-Profil Installation abgeschlossen.${NC}"
